...
def _wasi_platform_constraints_test_impl(ctx):
    ...
    # Test WASI Preview 3 (experimental)
    wasm32_wasip3_constraints = triple_to_constraint_set("wasm32-wasip3")
    asserts.equals(
        env,
        [
            "@platforms//cpu:wasm32", 
        ...
        wasm32_wasip3_constraints,
        "wasm32-wasip3 should map to WASI preview 3 constraints (experimental)"
    )
    ...
    # Test wasm32v1-none
    wasm32v1_none_constraints = triple_to_constraint_set("wasm32v1-none")
    asserts.equals(
        env,
        [
            "@platforms//cpu:wasm32",
        ...
        wasm32v1_none_constraints,
        "wasm32v1-none should map to wasm32 CPU with no OS"
    )
